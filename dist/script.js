...
function (_Slider) {
  ...
  function MainSlider(btns) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns)); //получаем доступ к свойствам
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      this.slides.forEach(function (slide) {
        slide.style.display = "none"; // slide.classList.remove('animated');
    ...
    value: function bindTriggers() {
      ...
      document.querySelectorAll('.nextmodule').forEach(function (item) {
        item.addEventListener('click', function (e) {
          // отменяем всплытие лишних событий(если класс повторяется и код выполняется для других стрелок)
          e.stopPropagation();
          e.preventDefault();
    ...
    value: function render() {
      // т.к. контейнеры могуть быть разными, првоеряем есть ли на странице контейнер
      if (this.container) {
        try {
...
var Slider = // конструируем свойства
function Slider() {
